...
if G_LOCALE == "ruRU" then
    ...
    TARGETCHARMS_RAID_MARKERS_UNAVAILABLE = "Система рейдовых меток сейчас недоступна.";
    ...
    TARGETCHARMS_RAID_MARKERS_UNAVAILABLE = "Raid marker system is unavailable right now.";
